...
//==============================================================================
class StereoDelayerAudioProcessor  : public juce::AudioProcessor
{
public:
    friend class StereoDelayerAudioProcessorEditor;
    //==============================================================================
    StereoDelayerAudioProcessor();
    ~StereoDelayerAudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (StereoDelayerAudioProcessor)
};
