...
//==============================================================================
StereoDelayerAudioProcessor::StereoDelayerAudioProcessor()
                       ...
                       ),m_algo(this), m_parameterVTS(nullptr)
{
    ...
    m_parameterVTS = std::make_unique<AudioProcessorValueTreeState>(*this, nullptr, Identifier("StereoDelayerVTS"),
...
//==============================================================================
const juce::String StereoDelayerAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool StereoDelayerAudioProcessor::acceptsMidi() const
{
...
bool StereoDelayerAudioProcessor::producesMidi() const
{
...
bool StereoDelayerAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double StereoDelayerAudioProcessor::getTailLengthSeconds() const
{

    return 0.0;
}

int StereoDelayerAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int StereoDelayerAudioProcessor::getCurrentProgram()
{
    return 0;
}

void StereoDelayerAudioProcessor::setCurrentProgram (int index)
{
    juce::ignoreUnused (index);
}

const juce::String StereoDelayerAudioProcessor::getProgramName (int index)
{
    juce::ignoreUnused (index);
    return {};
}

void StereoDelayerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
    juce::ignoreUnused (index, newName);
}

//==============================================================================
void StereoDelayerAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void StereoDelayerAudioProcessor::releaseResources()
{
    // When playback stops, you can use this as an opportunity to free up any
    // spare memory, etc.
}

bool StereoDelayerAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void StereoDelayerAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer,
...
//==============================================================================
bool StereoDelayerAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* StereoDelayerAudioProcessor::createEditor()
{
    return new StereoDelayerAudioProcessorEditor (*this);
}

//==============================================================================
void StereoDelayerAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void StereoDelayerAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new StereoDelayerAudioProcessor();
}
